        ...
        <main v-else class="page-roulette">
            <div class="sidebar">
                <p class="type-label-md" style="color: #aaa">
                    Gracias a <a href="https://matcool.github.io/extreme-demon-roulette/" target="_blank">matcool</a> por su ruleta.
                </p>
                <form class="options">
                    <div class="check">
    ...
    methods: {
        ...
        async onStart() {
            ...
            if (this.useLegacyList) {
                list.push(...fullListMapped.slice(101, 110));
            }
